...
namespace Microsoft.Samples.Kinect.DiscreteGestureBasics 
{
    ...
    public class GestureDetector : IDisposable
    {
        ...
        private readonly string stopGestureName = "Stop";
        private readonly string goGestureName = "Go";
        ...
        public GestureDetector(KinectSensor kinectSensor, GestureResultView gestureResultView)
        {
            ...
            using (VisualGestureBuilderDatabase database = new VisualGestureBuilderDatabase(this.gestureDatabase))
            {
                ...
                {
                    if (gesture.Name.Equals(this.stopGestureName))
                    {
            ...
            using (VisualGestureBuilderFrame frame = frameReference.AcquireFrame())
            {
                if (frame != null)
                {
                    ...
                    if (discreteResults != null)
                    {
                        ...
                        {
                            if (gesture.Name.Equals(this.stopGestureName) && gesture.GestureType == GestureType.Discrete)
                            {
